...
public class Doctor {
    ...
    public Doctor(Long id, String name, String specialty, LocalDateTime workingHoursStart, LocalDateTime workingHoursEnd, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.name = name;
